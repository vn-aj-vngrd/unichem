<div class="container white-box-container round-edge">
                    ...
                    <input type="hidden" name="create" value="supplier">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputEmail4" name="contactFName" required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="inputPassword4" name="contactLName" required>
                        </div>
                        <div class="col-md-6">
